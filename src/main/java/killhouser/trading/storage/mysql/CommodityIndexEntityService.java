...
public class CommodityIndexEntityService {
    ...
    public void saveAll(List<CommodityIndexEntity> commodityIndexEntities){
        try {
            ...
            String logMessage = String.format("Unable to save commodity index prices! :: %s", commodityIndexEntities);
            throw BaseException.create(ResponseCode.MYSQL_ERROR, "Unable to save commodity index prices!", logMessage, e);
        }
    }
}
